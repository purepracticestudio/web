...
$(function(){
	...
	$("#goto1").on("click", function(e){
  $('html, body').animate({
    scrollTop: $("#fafa-1").offset().top  // 只需修改此處
  }, 0);  // 750是滑動的時間，單位為毫秒
  e.preventDefault();
});
//專案收起-2/
...
$(function(){
  ...
  $('html, body').animate({
    scrollTop: $("#fafa-2").offset().top  // 只需修改此處
  }, 0);  // 750是滑動的時間，單位為毫秒
  e.preventDefault();
});
//專案收起-2/
  ...
  */
  ...
  $('.submit').on('click',function(e){
    ...
    var data = JSON.stringify({ 'CustomerName': $(':text[name="name"]').val(),
            ...
            'HouseStatus': '4',
            'Note': '綠建材專案來案，請與客戶聯繫後更新資料。', //'OO專案案來案，請與客戶聯繫後更新資料。'
            'ServiceItems': [],
            'TitleName':'環保建材,綠建材,CNS認證,甲醛檢測,新成屋裝修,中古屋修繕|信義居家', //修成此專案的title
            'TitleUrl': 'https://living.sinyi.com.tw/events/green-building-material/'   //修成此專案的網址命名
    });
